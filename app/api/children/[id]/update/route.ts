 ...
 * Body: { first_name?, date_of_birth?, member_status?, invited_email?, invited_phone?, kid_sage_tone? }
...
async function updateChild(
  ...
  const updatePayload: { first_name?: string; date_of_birth?: string | null; member_status?: string; invited_email?: string | null; invited_phone?: string | null; kid_sage_tone?: string } = {};
  ...
  const { data: row, error } = await admin
    ...
    .is("deleted_at", null)
    .select("id, first_name, date_of_birth, member_status, invited_email, invited_phone, kid_sage_tone")
    .single();
