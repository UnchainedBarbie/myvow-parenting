...
/**
 * POST /api/expenses/delete — soft delete expenses by ID (set deleted_at).
 * Body: { ids: string[] }
 * Only deletes expenses in the authenticated user's case.
 */
export async function POST(req: NextRequest) {
  try {
    ...
    if (error) {
      console.error("[delete-expenses] Supabase error:", error);
